export const content = {
  ...
  agent: {
    ...
    tools: 'Tool calls',
    results: 'Results',
    running: 'Running · step {step} · {tools} {toolUnit} · {seconds}s',
    consoleComplete: 'Complete · {steps} {stepUnit} · {tools} {toolUnit} · {seconds}s',
    consolePaused: 'Paused · {steps} {stepUnit} · {tools} {toolUnit} · {seconds}s',
    consoleError: 'Error · {steps} {stepUnit} · {tools} {toolUnit} · {seconds}s',
    toolGroup: 'Ran {count} {toolUnit}',
    stepUnitOne: 'step',
    stepUnitMany: 'steps',
    toolUnitOne: 'tool call',
    toolUnitMany: 'tool calls',
    ...
    subagentComplete: 'Subagent complete · {steps} {stepUnit} · {tools} {toolUnit}',
    subagentError: 'Subagent failed · {steps} {stepUnit} · {tools} {toolUnit}',
    ...
    strippedToolCallNote: '[tool call executed - see the run record]',
  },
  permission: {
